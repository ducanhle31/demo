...
export const FormContact = (props: IForm) => {
  ...
  return (
    <Box rounded={"sm"} px={"60px"} py={"24px"} h={"max-content"}>
      <Heading
        fontSize={"36px"}
        lineHeight={"48px"}
        textAlign={"left"}
      ...
      >
        {!sucess && (title || "Contact us for any kind of help at any time...")}
        {sucess && "Thành công"}
      </Heading>
      <Text
        mb={"40px"}
      ...
      >
        At vero eos et accusamus et iusto odio digni goiku tori ssimos ducimus
        qui blanditiis.
      </Text>
      {!sucess && (
        <Formik
