...
const infoInit = [
    ...
    detail: [
      {
        title: "",
        list: [
          "Chương trình Đào tạo từ xa của Học Viện Tài Chính (TNU) chỉ áp dụng hình thức xét tuyển đầu vào (không thi tuyển), áp dụng với mọi đối tượng học viên.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    detail: [
      {
        title: "Trạm tuyển sinh Học Viện Tài Chính:",
        list: [
    ...
    detail: [
      {
        ...
        list: [
          "Cấp bằng Cử nhân Học Viện Tài Chính.",
          "Văn bằng do Đại học do Học Viện Tài Chính cấp, được Bộ GD&ĐT công nhận.",
  ...
  return (
    <Container maxW={"6xl"}>
      <HeadSection
        ...
        subtitle="thông báo"
        desc="Thông báo tuyển sinh hệ từ xa Học Viện Tài Chính 2023"
      />
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={"32px"} pt={"24px"}>
        ...
        <GridItem>
          <Image
            ...
            alt="Phôi bằng Học Viện Tài Chính"
            width={500}
            height={700}
          />
          <Text textAlign={"center"} fontWeight={"bold"}>
            Phôi bằng Học Viện Tài Chính
          </Text>
        </GridItem>
      </SimpleGrid>
    </Container>
